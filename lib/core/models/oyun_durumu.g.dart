...
_OyunDurumu _$OyunDurumuFromJson(Map<String, dynamic> json) => _OyunDurumu(
  ...
  isletmeler:
      (json['isletmeler'] as List<dynamic>?)
          ?.map((e) => Isletme.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const <Isletme>[],
  ilgi: json['ilgi'] == null
      ? const IlgiDagilimi()
  ...
  zirveNetDeger: (json['zirveNetDeger'] as num?)?.toInt() ?? 0,
...
Map<String, dynamic> _$OyunDurumuToJson(_OyunDurumu instance) =>
    <String, dynamic>{
      ...
      'zirveNetDeger': instance.zirveNetDeger,
